...
function App() {
  return (
    <div className='App'>
      <main>
        <img src={flor} alt="flo" className='flor flor__left' />
        <img src={flor} alt="flo" className='flor flor__left sec' />
        <img src={mancha} alt="flo" className='mancha mancha__right' />
      <section className='hero'>
        ...
        <div className='conteo'>
          ...
          /> <img src={flor} alt="flo" className='flor flor__left' />
        <img src={flor} alt="flo" className='flor flor__right' />
      ...
      <section className='formulario'>
        ...
        <Form />
       <img src={mancha} alt="flo" className='mancha mancha__right' /></section></main>
      <footer>
        <p>
